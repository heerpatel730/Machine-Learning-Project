...
def main():
	...
	print("Navi bayes is a generative model where as LR is a discriminatiove so navie bayes works well with smalldataset. Navi bayes gives best results when compared with all so it will give more accuracy and others outperform")
	print('END Q3_C\n')
